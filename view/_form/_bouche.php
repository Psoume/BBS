...
<button type="button" class="btn btn-success me-2" onclick="newEquipement('Bouche')">Ajouter un équipement</button>
<button type='button' onclick="deleteInput('table_Bouche_tbody',0)" >Supprimer</button>
